...
- 現状: document-generator Phase 1 ユーザー作業完了（2026-05-27）。Claude 実装タスク進行中（types 完了、sheetService 完了、templateService 完了、次は placeholderService）。
